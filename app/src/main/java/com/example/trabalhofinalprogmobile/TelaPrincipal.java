...
public class TelaPrincipal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botao_catalogo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(TelaPrincipal.this, Catalogo.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    private void IniciarComponentes() {
        ...
        botao_sair = findViewById(R.id.botao_sair);
        botao_catalogo = findViewById(R.id.botao_catalogo);
    }
